export const translations: Record<string, string> = {
  ...
  'CY Studios is a boutique creative agency taking clients in with intention, so every brand gets the attention it deserves.': 'CY Studios는 의도를 담아 클라이언트를 맞이하는 부티크 크리에이티브 에이전시입니다. 모든 브랜드가 마땅히 받아야 할 관심을 드리기 위해.',
  "It's Free": '무료입니다',
  'Who We Are': '우리에 대해',
  ...
  'Obsessed with craft. Believes every pixel tells a story, and makes sure yours tells the right one.': '디테일에 집착합니다. 모든 픽셀이 이야기를 전한다고 믿으며, 당신의 이야기가 제대로 전달되도록 합니다.',
  ...
  'We take on three clients per cohort so every project gets our full attention. Summer spots are open, and here\'s who we\'re looking for.': '코호트당 세 팀만 받습니다. 모든 프로젝트에 온전히 집중하기 위해서입니다. 여름 자리가 열렸습니다.',
  'Open': '모집 중',
